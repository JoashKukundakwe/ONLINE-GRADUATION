...
$academic_sec = $rowaccess['academic_secretary_approved'];
$academic_reg = $rowaccess['academic_registrar_approved'];
        ...
        <div class="navbar-header">
            ...
            <ul class="nav navbar-top-links navbar-right">
                <li>
                    ...
                    <span class="m-r-sm text-muted welcome-message">Welcome <b> <?php echo $rowaccess['fullname']; ?></span>
                </li>
                <li class="dropdown">
    ...
    ?>
                        ...
                        <div class="ibox float-e-margins">
                            ...
                            <div class="ibox-content">
                                <h3 class="no-margins">UGX<?php echo number_format((float) $tot_fee ,2); ?> </h3>
                                <small> </small> 
						  </div>
                        </div>
                    </div>             
...
<div class="col-lg-3">
                        <div class="ibox float-e-margins">
                            ...
                            <div class="ibox-content">
                                <h3 class="no-margins">UGX<?php echo number_format((float) $tot_pay ,2); ?></h3>
                                <small> </small> 
						  </div>
                        </div>
                    </div>    
					...
					<div class="col-lg-3">
                        <div class="ibox float-e-margins">
                          ...
                          <div class="ibox-content">
							  ...
							  <?php if (($outstanding_fee)=="0" && ($sport)=="1" &&($hostel)=="1" && ($stud_affairs)=="1" && ($academic_sec)=="1" && ($academic_reg)=="1") { ?>
...
<?php echo "Pending"; ?></div>
	  <?php } ?> </h3>
                        ...
                        <div class="ibox float-e-margins">
                            ...
                            <div class="ibox-content">
                                <h3 class="no-margins">UGX<?php echo number_format((float) $outstanding_fee ,2); ?>  </h3>
                                <small> </small> 
						  </div>
                        </div>
                    </div>             
    ...
    <div class="col-lg-12">
        ...
        <table width="1201" height="341" align="center">
            <tr>
                <td width="1237">
                    <table border="10" align="center" class="table table-hover no-margins">
                        
                        <thead>

    <tr>

        <th width="10%"><div align="center"><span class="style1">Accounts </span></div></th>
        <th width="10%"><div align="center"><span class="style1">Dean of Students</span></div></th>
        <th width="10%"><div align="center"><span class="style1">Library</span></div></th>
        <th width="10%"><div align="center"><span class="style1">Security</span></div></th>
        <th width="10%"><div align="center"><span class="style1">Dean Faculty</span></div></th>
        <th width="10%"><div align="center"><span class="style1">Academic Registrar</span></div></th>
        <th width="25%"><div align="center"><span class="style1">Uploads</span></div></th>
    </tr>
</thead>
   ...
   <td align="center">
    <?php if ($outstanding_fee == 0) { ?>
        <span class="label label-primary">Cleared</span>
    <?php } else { ?>
    ...
    <td align="center">
        <?php if ($rowaccess['academic_secretary_approved'] == 1) { ?>
            <span class="label label-primary">Cleared</span>
        <?php } else { ?>
            <span class="label label-warning">Pending</span>
        <?php } ?>
    ...
    <td align="center">
        <?php if ($rowaccess['academic_registrar_approved'] == 1) { ?>
            <span class="label label-primary">Cleared</span>
        <?php } else { ?>
            <span class="label label-warning">Pending</span>
        <?php } ?>
    ...
    <td align="center">
                            <!-- Button to take you to uploads.php with an icon -->
                            <a href="upload_receipts.php" class="btn btn-primary">
                                <i class="fa fa-upload"></i> Upload Receipts of Payment
                            </a>
                            </br>
                            </br>

                            <!-- Button to take you to uploads.php with an icon -->
                            <a href="upload_academic.php" class="btn btn-primary">
                                <i class="fa fa-upload"></i> Upload Academic Documents
                            </a>
                        </td>
</tr>
